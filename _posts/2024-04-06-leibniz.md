...
algebraically". This account eventually alludes to Leibniz's "progression of variables" but misses out any meaning for individual differentials and focuses on the derivatives of functions (a bit obsessively). It also fails to highlight why progression is different in first and then in higher differentials. Nothing about integration etc.
